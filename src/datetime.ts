...
export default class DateTime extends Date {
  private static readonly millsMultiplier = 1
  private static readonly secMultiplier = DateTime.millsMultiplier * 1000
  private static readonly minMultiplier = DateTime.secMultiplier * 60
  private static readonly hourMultiplier = DateTime.minMultiplier * 60
  private static readonly dayMultiplier = DateTime.hourMultiplier * 24
  constructor(options?: {
    year?: number
    month?: Month
    day?: Day
    ...
    if (options.second || options.second === 0) {
      this.setSeconds(options.second)
    }
    if (options.mills || options.mills === 0) {
      this.setMilliseconds(options.mills)
    }
  }
  ...
  public addDays(day: number) {
    this.addMills(DateTime.dayMultiplier * day)
  }
  ...
  public addHours(hour: number) {
    this.addMills(DateTime.hourMultiplier * hour)
  }
  ...
  public addMinutes(minutes: number) {
    this.addMills(DateTime.minMultiplier * minutes)
  }
  ...
  public addSeconds(seconds: number) {
    this.addMills(DateTime.secMultiplier * seconds)
  }
